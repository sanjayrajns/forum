...
export default function ImpactPage() {
  return (
    <div className="pt-24 space-y-0">
      ...
      {/* Geographic Reach (Muted styled visualizer) */}
      <section className="py-16 md:py-32 bg-ivory border-b border-hairline overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <h2 className="font-serif text-4xl md:text-5xl font-medium text-navy tracking-tight leading-tight">
                Spreading the Synergy
              </h2>
              <p className="text-sm font-sans text-ink/75 leading-relaxed font-light">
                From our headquarters in Bengaluru, Karnataka, we coordinate
                digital mentoring and physical workshops targeting institutions
                across states.
              </p>
              <div className="space-y-3 pt-2">
                <div className="flex justify-between text-xs font-sans border-b border-hairline pb-2">
                  <span className="text-navy font-semibold">Headquarters</span>
                  <span className="text-ink/60">Bengaluru, Karnataka</span>
                </div>
                <div className="flex justify-between text-xs font-sans border-b border-hairline pb-2">
                ...
                <div className="flex justify-between text-xs font-sans border-b border-hairline pb-2">
                  ...
                  <span className="text-ink/60">
                    Tier 2 / Tier 3 Campus Hubs
                  </span>
                </div>
              </div>
            </div>

            {/* Right Column Custom desaturated visual map */}
            <div className="lg:col-span-7 bg-card border border-hairline aspect-video w-full flex items-center justify-center p-8 relative overflow-hidden">
              <div className="absolute inset-0 bg-navy/[0.02]" />
              {/* Minimalist Grid representation representing state hubs */}
              <div className="relative text-center space-y-3 z-10">
                <span className="text-[10px] font-sans uppercase tracking-widest text-gold font-bold">
                  Network Node Map
                </span>
                <p className="text-xs font-sans text-ink/40 max-w-sm mx-auto leading-relaxed">
                  A custom desaturated GIS representation of our active
                  university chapters and digital hubs will load here under
                  compliance.
                </p>
                <div className="flex justify-center gap-1.5 pt-4">
                  <span className="w-2.5 h-2.5 bg-navy rounded-full animate-ping" />
